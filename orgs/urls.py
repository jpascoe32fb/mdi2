...
urlpatterns = [
    ...
    path('continue-entry/<int:report_id>/', views.continue_entry, name='continue_entry'),
    path('continue-entry/<path:attachment_url>/', views.show_attachments, name="show_attachments"),
    ...
    path('create-copy/<int:node_id>/', views.tree_create_copy, name='tree-create-copy'),
    ...
    path('get-report/<int:report_id>/', views.report, name='get-report'),
    path('get-table-reports/', views.get_table_reports_company, name='get-table-reports-company'),
    path('close-report/<int:report_id>/', views.close_report, name='close-report')
]